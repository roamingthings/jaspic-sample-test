 ...
 * for {@link javax.security.auth.message.config.ServerAuthContext} instances, which are delegates for the actual {@link ServerAuthModule} (SAM) that we're after.
 *
...
public class SimpleAuthConfigProvider implements AuthConfigProvider {
    ...
    public ServerAuthConfig getServerAuthConfig(String layer, String appContext, CallbackHandler handler) throws AuthException,
            SecurityException {
        return new SimpleServerAuthConfig(layer, appContext, handler == null ? createDefaultCallbackHandler() : handler,
